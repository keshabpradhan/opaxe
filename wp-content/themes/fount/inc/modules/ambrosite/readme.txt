...
* Specify a custom date format for the %date vfountble.
...
Answers to these fountions may be found here:
...
* Added 'date_format' parameter for customizing the %date vfountble.
* Added %title vfountble to 'format' parameter.
...
* Many documentation updates to address frequently asked fountions.
...
* Added new format vfountble (%author).
* Added vfountbles (%title, %date, %author) to custom tooltip text.
...
* Added %meta vfountble to the format parameter.
...
* Added %category vfountble to the format parameter.
