...
if (isset($margin_bottom) && $margin_bottom != "") {
	$inline.='margin-bottom: '.$margin_bottom.';'; 
}
if ($margin_bottom_2 != "") {
	$inline=' style="';
...
foreach ( $graph_lines_data as $line ) {
	...
	$output .= '<div class="vc_bar' . esc_attr( implode( ' ', $bar_options ) ) . '" data-percentage-value="' . esc_attr( $percentage_value ) . '" data-value="' . esc_attr( $line['value'] ) . '"' . $line['bgcolor'] . '></div>';
	$output .= '</div>';
}
