...
<head>
    <title>OPAXE - Smart Information - Informed Decisions</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
    <meta name="description" content="RSC-MI Email Forms">
    <meta name="keywords" content="RSC-MI">
...
<div class="wrapper rounded6" id="templateContainer">
    ...
    <div id="templateBody" class="bodyContent rounded6">
        ...
        <div><p>A confirmation email has been sent to your email with a link to activate your account.</p>
	     <p>If the email doesn't show up soon, please check your spam folder. We sent it from info@opaxe.com</p>

            <p>Tip: Add us to your address book to ensure that our newsletter does not end up in your junk or spam folder.</p>
            <div class="vcard">
<!--
<span class="org fn">RSCMME</span>
<div class="adr">
	<div class="street-address">PO Box 803</div>
	<span class="locality">West Perth</span>, <span class="region">WA</span>  <span class="postal-code">6872</span> 
	<div class="country-name">Australia</div>
</div>
-->
<br><a href="/wp-content/uploads/opaxe.vcf" class="hcard-download">Add us to your address book</a></div>
        </div>
        <br>
<!--        <a class="formEmailButton" href="/intel?login=true">&laquo; return to our website</a> -->
...
<div style="margin: 238px">
    <div class="alert alert-danger" style="background-color: #f2dede; border-color: #ebccd1; color: #a94442!important;display: none">
