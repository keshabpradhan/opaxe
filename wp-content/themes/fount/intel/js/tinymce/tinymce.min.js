...
function(e, t) {
	...
	r(l, [], function() {
		...
		function n(e) {
			return null === e || e === t ? "" : ("" + e).replace(b, "")
		}
		function r(e, n) {
			return n ? "array" == n && x(e) ? !0 : typeof e == n : e !== t
		}
		function i(e) {
			var t = e,
				n, r;
			if (!x(e)) for (t = [], n = 0, r = e.length; r > n; n++) t[n] = e[n];
			return t
		}
		function o(e, t, n) {
			var r;
		...
		function a(e, n, r) {
			...
			for (i in e) if (e.hasOwnProperty(i) && n.call(r, e[i], i, e) === !1) return 0;
			return 1
		}
		function s(e, t) {
			var n = [];
		...
		return f.prototype = {
			...
			getParents: function(e, n, r, i) {
				var o = this,
					a, s = [];
				for (e = o.get(e), i = i === t, r = r || ("BODY" != o.getRoot().nodeName ? o.getRoot().parentNode : null), p(n, "string") && (a = n, n = "*" === n ?
				function(e) {
					return 1 == e.nodeType
				} : function(e) {
					return o.is(e, a)
		...
		return function(a) {
			...
			function b(t, n, r) {
				...
				if (u) if (r) r.nodeType ? (h = q.createRng(), h.setStartBefore(r), h.setEndAfter(r), l(H(h, c), null, !0)) : l(r, null, !0);
			...
			function w(e, t, n, r) {
				function i(e, t, i) {
					...
					for (l = 0; l < s.length; l++) if ("attributes" === i ? q.getAttrib(e, s[l]) : A(e, s[l])) return t;
					return t
				}
				var o = p(t),
					a, s, l;
			...
			function V(t, n, r, i) {
				...
				function d(e, t) {
					...
					else if (e = c(j.getStart()), !e) for (; e = q.get(g);) d(e, !1)
				}
				function f() {
					var e, t, i, a, s, l, d;
				...
				function h() {
					...
					if (d) if (c) l = j.getBookmark(), e.collapse(!0), e = H(e, p(n), !0), e = K.split(e), x(n, r, e), j.moveToBookmark(l);
					else {
		...
		return function(i) {
			function o(o) {
				...
				function y(e) {
					...
					if (e || "TABLE" == I ? (n = a.create(e || z), v(n)) : n = D.cloneNode(!1), o = n, l.keep_styles !== !1) do
					if (s[t.nodeName]) {
				...
				var k, T, R, A, B, D, L, M, H, P, O, I, F, z, W;
				if (k = s.getRng(!0), !o.isDefaultPrevented()) {
					if (!k.collapsed) return void i.execCommand("Delete");
					if (new t(a).normalize(k), A = k.startContainer, B = k.startOffset, z = (l.force_p_newlines ? "p" : "") || l.forced_root_block, z = z ? z.toUpperCase() : "", L = a.doc.documentMode, M = o.shiftKey, 1 == A.nodeType && A.hasChildNodes() && (W = B > A.childNodes.length - 1, A = A.childNodes[Math.min(B, A.childNodes.length - 1)] || A, B = W && 3 == A.nodeType ? A.nodeValue.length : 0), R = E(A)) {
						if (c.beforeChange(), !a.isBlock(R) && R != a.getRoot()) return void((!z || M) && w());
						if ((z && !M || !z && M) && (A = x(A, B)), D = a.getParent(A, a.isBlock), O = D ? a.getParent(D.parentNode, a.isBlock) : null, I = D ? D.nodeName.toUpperCase() : "", F = O ? O.nodeName.toUpperCase() : "", "LI" != F || o.ctrlKey || (D = O, I = F), /^(LI|DT|DD)$/.test(I)) {
							if (!z && M) return void w();
							if (a.isEmpty(D)) return void C()
						}
						if ("PRE" == I && l.br_in_pre !== !1) {
							if (!M) return void w()
						} else if (!z && !M && "LI" != I || z && M) return void w();
		...
		function i(e, t) {
			...
			if (r.isArray(t)) {
				...
				for (n = e.length; n--;) if (!i(e[n], t[n])) return !1
			}
			o = {};
			for (n in t) {
			...
			for (n in e) if (!o[n] && !i(e[n], t[n])) return !1;
			return !0
		}
		return n.extend({
			Mixins: [t],
		...
		return function(i) {
			function o(e, t, n) {
				var r = 0;
				do r = e.indexOf(t, r), -1 !== r && (e = e.substring(0, r) + n + e.substr(r + t.length), r += n.length - t.length + 1);
				while (-1 !== r);
				return e
			}
			function a(e, t, n) {
