...
function ihc_print_form_password($meta_arr){
	...
	case 'ihc-login-template-3':
		$str .=  '<div class="impu-form-line-fr">'
						. '<input type="text" value="" name="email_or_userlogin" placeholder="' . __('Please enter your registered Username or E-mail', 'ihc') . '" />'
					. '</div>'
	...
	case 'ihc-login-template-4':
		$str .=  '<div class="impu-form-line-fr">'
						. '<i class="fa-ihc fa-username-ihc"></i><input type="text" value="" name="email_or_userlogin" placeholder="'.__('Please enter your registered Username or E-mail', 'ihc').'" />'
					. '</div>'
					. '<div class="impu-form-submit">'
						. '<input type="submit" value="' . __('Get New Password', 'ihc') . '" name="Submit" class="button button-primary button-large">'
					. '</div>';
	...
	default:
		$str .=  '<div class="impu-form-line-fr">'
					. '<span class="impu-form-label-fr impu-form-label-username">' . __('Please enter your registered Username or E-mail', 'ihc') . ': </span>'
		...
		$str .= '<div  class="impu-form-links">';
			if($meta_arr['ihc_login_register']){
				...
				if($pag_id!==FALSE){
					$register_page = get_permalink( $pag_id );
					if (!$register_page) $register_page = get_home_url();
					$str .= '<div class="impu-form-links-reg">'.__('Don\'t have an account?', 'ihc').'<a href="'.$register_page.'">'.__('Sign Up', 'ihc').'</a></div>';
				}
			}
								...
								jQuery("#ihc_fileuploader_wrapp_' . $rand . ' .ihc-file-upload").uploadFile({
									...
									onSuccess: function(a, response, b, c){
										if (response){
											...
											jQuery(".page-id-5109 .ihc-wrapp-file-upload").before("<a id=" + image_name + " href=" + obj.url + ">" +obj.file_name.filename + "." + obj.file_name.extension + "</a>");
											jQuery(".page-id-5109 .ajax-file-upload").addClass("hidden-upload-btn");
											$(".ihc-wrapp-file-upload").css("padding-top","40px");
											setTimeout(function(){
												jQuery("#ihc_fileuploader_wrapp_' . $rand . ' .ajax-file-upload-container").css("display", "none");
											}, 3000);
										}
