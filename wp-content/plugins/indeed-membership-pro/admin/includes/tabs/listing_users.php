					...
					<div class="ihc-column column-one">
						...
						<div class="ihc-settings-inner">
							...
							<div class="ihc-user-list-row">							
								...
								<input type="checkbox" id="inside_page" <?php echo $checked;?> onClick="ihc_preview_u_list();"/> <?php _e("Activate Public Individual Page", 'ihc');?>
							 ...
							 <div class="iump-form-line">
								...
								<div style="margin-top: 10px;">
									<label class="iump_label_shiwtch iump-onbutton">
										...
										<input type="checkbox" class="iump-switch" onClick="iump_check_and_h(this, '#ihc_listing_users_inside_page_show_website');" <?php echo $checked;?> />
										<div class="switch" style="display:inline-block;"></div>
									</label>
