				...
				<div style="font-weight:bold"><?php _e('Predefined Wordpress Role Assign to new Users:', 'ihc');?></div>
					...
					<p><?php _e('If the "Pending" role is set, the user will not able to login until the admin manually approves it.', 'ihc');?></p>	
						...
						<div class="iump-form-line">
							...
							<p><?php _e('Be sure that your notifications for “Double Email Verification” are properly set up. Make sure to check the settings from the “', 'ihc');?> <a href="admin.php?page=ihc_manage&tab=general&subtab=double_email_verification" target="_blank"><?php _e('General Options', 'ihc');?></a><?php _e(' tab.', 'ihc');?></p>	
						</div>
