	...
	<div class="ihc-stuffbox">
		...
		<div class="inside">
			...
			<div class="iump-form-line">
				...
				<p style="max-width:70%;"><?php _e('Replace the default redirect after login with a custom one based on the user’s assigned level. Because UMP is a MultiLevel system, a user can have multiple levels assigned but only one redirect can take place. You can set level priorities to manage that.', 'ihc');?></p>	
