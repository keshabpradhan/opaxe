	...
	<div class="ihc-stuffbox">
		...
		<div class="inside">
			...
			<div class="iump-form-line">
				...
				<p><?php _e('Display all the posts that a user can see based on his subscriptions', 'ihc'); ?></p>
			...
			<div class="iump-form-line">
				...
				<p><?php _e('Select which post types show up, you can select specific ones or all of them.', 'ihc');?></p>	
